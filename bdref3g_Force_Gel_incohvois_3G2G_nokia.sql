--cette requête permet de forcer le Gel en zone Nokia sur des cellules avec uniquement des Ajouts de voisines 3G2G (typiquement les extensions)
UPDATE public.bdref_visuincohtopo_vois_3g2g_nokia
SET "Etats" = 'OK'
WHERE 
