...
SELECT  
  xmlconcat(
	...
	xmlelement( --exemple de format: <managedObject class="WBTS" version="mcRNC16" distName="PLMN-PLMN/RNC-58/WBTS-2" id="205626">
		name "managedObject",
		xmlattributes("object_type" as "class", "managedObject_distName" as "distName", 'delete' as "operation","managedObject_version" as "version")
	)
  ) AS xml_allobjects
FROM t_adjs_adji_generic_delete
