...
SELECT
  ...
  xmlelement(    
	...
	xmlelement(
		name "attributes",
		xmlconcat(
			named_node('alarmPriorityTableConfClassId', alarmprioritytableconfclassid),
			named_node('cacPriorityTableConfClassId', cacprioritytableconfclassid),
			...
			named_node('reserved4', reserved4),
			named_node('reserved5', reserved5),
			named_node('reserved6', reserved6),
			named_node('reserved7', reserved7),
			...
			named_node('userSpecificInfo', userspecificinfo)
