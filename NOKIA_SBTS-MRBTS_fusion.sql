...
--l'objet SBTS. A terme lors de la disparition du SBTS, il faudra supprimer cette fusion et modifier les autres requêtes.
...
FROM 
  public."nokia_MRBTS" LEFT JOIN public."nokia_SBTS"
  ON
...
WHERE
  "nokia_SBTS"."managedObject_SBTS" IS NULL --on rajoute cette jointure pour éviter en cas de reproceesing de rerajouter les MRBTS
;
