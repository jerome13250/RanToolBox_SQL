SELECT 
  string_agg(snap3g_cellselectionwithpriorityprofile.rnc,'-'),
  count(snap3g_cellselectionwithpriorityprofile.rnc), 
...
WHERE 
  snap3g_cellselectionwithpriorityprofile.rnc != 'BACKUP_A' AND
  snap3g_cellselectionwithpriorityprofile.rnc NOT LIKE 'RS%' AND 
...
GROUP BY
  ...
  snap3g_eutranfrequencyandpriorityinfolist.measurementbandwidth
ORDER BY
  snap3g_cellselectionwithpriorityprofile.cellselectionwithpriorityprofile::int,
  snap3g_eutranfrequencyandpriorityinfolist.eutratargetdlcarrierfrequencyarfcn
