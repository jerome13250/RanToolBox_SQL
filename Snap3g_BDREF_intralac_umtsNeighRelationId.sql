SELECT 
  ...
  'UmtsNeighbouring/0 UmtsNeighbouringRelation/' || bdref_mapping_neighbrel_interlac.neighbrel_intralac AS valeur,
  'Reselection intraLAC' AS commentaire

  
FROM 
  public.t_voisines3g3g INNER JOIN public.bdref_mapping_neighbrel_interlac
  ON 
     t_voisines3g3g.umtsneighrelationid = bdref_mapping_neighbrel_interlac.neighbrel_interlac
WHERE 
  t_voisines3g3g.locationareacode_s = t_voisines3g3g.locationareacode_v AND
